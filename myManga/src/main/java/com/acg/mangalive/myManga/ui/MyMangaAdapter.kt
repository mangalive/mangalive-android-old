...
import com.acg.mangalive.myManga.databinding.CardCatalogBinding
import com.acg.mangalive.share.R as shareR

class MyMangaAdapter(context: Context) :
    PagingDataAdapter<MangaCard, MyMangaAdapter.ViewHolder>(DiffItemCallback) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
        ViewHolder(
            CardCatalogBinding.inflate(
    ...
    inner class ViewHolder(private val binding: CardCatalogBinding) :
