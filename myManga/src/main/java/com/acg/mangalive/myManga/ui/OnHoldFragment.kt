...
import com.acg.mangalive.myManga.databinding.FragmentDroppedBinding
...
class OnHoldFragment : Fragment() {
    private var _binding: FragmentOnHoldBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentOnHoldBinding.inflate(inflater, container, false)
        return binding.root
    }
